...
@Setter
@ToString
public class QnAOneBoardResponse {
    ...
    private List<QnAAnswerResponse> comments;

    @QueryProjection
    public QnAOneBoardResponse(Long id, String title, String content, String writerId, boolean fixed, boolean secret,
