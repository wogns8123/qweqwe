...
@ApiModel(description = "고민게시글 목록 응답 모델")
@Getter
@Setter
@ToString
public class TroubleResponse {
    ...
    @QueryProjection
    public TroubleResponse(Long postId, String category, String title, String content, String clientId,
                              Integer views, LocalDateTime createdAt, Integer commentCount) {
        this.postId = postId;
